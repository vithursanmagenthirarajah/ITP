...
export default class IssueTreatmentItem extends Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:5000/api/IssueTreatment/'+this.props.match.params.id)
      .then(response => {
        this.setState({
  ...
  onSubmit(e){
    ...
    axios.post('http://localhost:5000/api/IssueTreatment/update/'+this.props.match.params.id,IssueTreatmentDetails)
  ...
  render() {
    return (
      <div>
     <Head/>
      <h1  style={{textAlign:"center"}}> Update Issued Treatment Items </h1><br/><br/>
      <div class="center"> 
      ...
      <Form.Group as={Row} controlId="formHorizontaltreatmentID">
        ...
        <Col sm={5}>
          <Form.Control type="text"   required onChange={this.onChangeTreatId} value={this.state.treatid} placeholder="Treatment ID" />
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} controlId="formHorizontalName">
        ...
        <Col sm={5}>
          <Form.Control type="text" required    onChange={this.onChangeTreatName} value={this.state.treatname} placeholder="Treatment Item Name" />
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} controlId="formHorizontalQuantity">
        ...
        <Col sm={5}>
          <Form.Control type="number" required  onChange={this.onChangeQuantity} value={this.state.quantity} placeholder="Quantity" />
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} controlId="formHorizontalDate">
        ...
        <Col sm={5}>
          <Form.Control type="date" required onChange={this.onChangeDate} value={this.state.date}  placeholder="Issue date" />
        </Col>
      </Form.Group>
      ...
      <Col sm={5}>
        <Form.Control type="text" required onChange={this.onChangeIssueTo} value={this.state.issueto}  placeholder="Issue to" />
      </Col>
    </Form.Group>
    ...
    <Col sm={5}>
      <Form.Control type="text" required onChange={this.onChangeType} value={this.state.type}  placeholder="type" />
    </Col>
  </Form.Group>
