...
const IngredientDetails = props => (
    <tr>
      ...
      <td>
      <Button variant="dark"><Link to={"/update/"+props.ingredientDetails._id}>update</Link></Button> |  <Button variant="danger" href="#" onClick={() => { props.deleteingredientDetails(props.ingredientDetails._id) }}>delete</Button>
      </td>
    </tr>
  )
...
export default class ViewIngredient extends Component {
    ...
    constructor(props) {
      ...
      deleteingredientDetails(id) {
        axios.delete('http://localhost:5000/api/ingredient/'+id)
      ...
      IngredientList() {
        return this.state.Ingredient.map(currentingredientDetails => {
          return <IngredientDetails ingredientDetails={currentingredientDetails} deleteingredientDetails={this.deleteingredientDetails} key={currentingredientDetails._id}/>;
        })
